...
src = partial(
    Option,
    '--dashboard', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    metavar='dir',
    default=get_src_prefix(),
    help='Directory to check out editable projects into. '
    'The default in a virtualenv is "<venv path>/dashboard". '
    'The default for global installs is "<current dir>/dashboard".'
)  # type: Callable[..., Option]
