...
def get_src_prefix():
    if running_under_virtualenv():
        src_prefix = os.path.join(sys.prefix, 'dashboard')
    else:
        # FIXME: keep dashboard in cwd for now (it is not a temporary folder)
        try:
            src_prefix = os.path.join(os.getcwd(), 'dashboard')
        except OSError:
